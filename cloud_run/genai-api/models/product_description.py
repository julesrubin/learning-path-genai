...
class ProductDescriptionRequest(BaseModel):
    ...
    categories: List[str] = Field(
        ..., examples=[["Outdoor", "Fitness", "Sustainability"]]
    )
...
class ProductDescriptionResponse(BaseModel):
    description: str = Field(
        ...,
        examples=[
            "This eco-friendly water bottle is perfect for outdoor enthusiasts..."
        ],
    )
    seo_keywords: List[str] = Field(
        ..., examples=[["eco-friendly", "water bottle", "sustainable"]]
    )
